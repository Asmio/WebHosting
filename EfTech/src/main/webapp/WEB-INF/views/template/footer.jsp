        ...
        <ul>
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="resources/assets/images/blank.gif" data-echo="resources/assets/images/products/product-small-04.jpg" />
                        </a>
                    </div>
                </div>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="resources/assets/images/blank.gif" data-echo="resources/assets/images/products/product-small-05.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="resources/assets/images/blank.gif" data-echo="resources/assets/images/products/product-small-06.jpg" />
                        </a>
                    </div>
                </div>
            </li>
        ...
        <ul>
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="resources/assets/images/blank.gif" data-echo="resources/assets/images/products/product-small-07.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="resources/assets/images/blank.gif" data-echo="resources/assets/images/products/product-small-08.jpg" />
                        </a>
                    </div>
                </div>
            </li>
            ...
            <li>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 no-margin">
                        <a href="#" class="thumb-holder">
                            <img alt="" src="resources/assets/images/blank.gif" data-echo="resources/assets/images/products/product-small-09.jpg" />
                        </a>
                    </div>
...
<!--    
    <div class="social-icons">
        <h3>Get in touch</h3>
        <ul>
            <li><a href="https://www.facebook.com/vmccnc/" class="fa fa-facebook"></a></li>
           <li><a href="https://www.youtube.com/channel/UCXZvi4ulrMI7SnJ5vde-BKA" ></a>YouTube</li>
            <li><a href="https://twitter.com/vmccnc" class="fa fa-twitter"></a></li>

            <li><a href="https://vk.com/vmccnc" class="fa fa-vk"></a></li>
        </ul>
    </div>-->
    <!-- /.social-icons -->
...
<!--                <div class="payment-methods ">
                    <ul>
                        <li><img alt="" src="resources/assets/images/payments/payment-visa.png"></li>
                        <li><img alt="" src="resources/assets/images/payments/payment-master.png"></li>
                        <li><img alt="" src="resources/assets/images/payments/payment-paypal.png"></li>
                        <li><img alt="" src="resources/assets/images/payments/payment-skrill.png"></li>
                    </ul>
                </div> /.payment-methods -->
            </div>
        </div><!-- /.container -->
